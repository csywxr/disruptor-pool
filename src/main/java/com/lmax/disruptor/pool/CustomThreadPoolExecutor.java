...
public class CustomThreadPoolExecutor extends java.util.concurrent.ThreadPoolExecutor {

    public CustomThreadPoolExecutor(int minThread,int maxThreads,int queueSize){
        super(minThread,maxThreads,0L,TimeUnit.MILLISECONDS,new ArrayBlockingQueue<Runnable>(queueSize));
    }
